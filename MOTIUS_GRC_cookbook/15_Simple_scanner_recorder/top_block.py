...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "scanner_recorder")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("scanner_recorder")
        ...
        self.iio_pluto_source_0 = iio.pluto_source(ip, int(center_freq), int(samp_rate), 20000000, 32768, True, True, True, 'manual', 50, '', True)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.iio_pluto_source_0.set_params(int(self.center_freq), int(self.samp_rate), 20000000, True, True, True, 'manual', 50, '', True)
